...
const setRequests = async (requestID: Requests) => {
  try {
    ...
    await axiosInstance.put(
     `https://localhost:7007/api/RequestToMoveClass/update`, data ,
      {
        headers: {
          Authorization: `Bearer ${authData?.token}`
  ...
  return (
    ...
    {/*Mentor approval box*/}
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-7 lg:py-7 mx-auto h-[90vh]">
        ...
        <div id="Requests" className="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabIndex={-1} aria-labelledby="hs-full-screen-label">
          <div className="hs-overlay-open:mt-0 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-10 opacity-0 transition-all max-w-full max-h-full h-full">
            <div className="flex flex-col bg-white pointer-events-auto max-w-full max-h-full h-full dark:bg-neutral-800">
              ...
              <div className="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                ...
                <button type="button" className="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600" aria-label="Close" data-hs-overlay="#Requests">
                  <span className="sr-only">Close</span>
                  <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M18 6 6 18"></path>
                    <path d="m6 6 12 12"></path>
              ...
              <div className="p-4 overflow-y-auto">
                <div className="mt-1 text-gray-800 dark:text-neutral-400">
                  {filterReq.map((requests)=> ( 
                    <div key={requests.studentId} className="grid grid-cols-5 py-2 border-4 rounded-lg ">
                    ...
                    <div className="col-span-2 border-l px-4 text-lg">
                      ...
                      <div className="font-bold">Reason: <br></br></div>
                      
                      {requests.reason}<br></br>
                    ...
                    <div className="col-span-1">
                      <div className="flex justify-end items-center gap-x-2 py-3 px-4">
                        {/*Change Status*/}
                        <button type="button" onClick={()=>{setRequests(requests)}}className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-basic-modal" data-hs-overlay="#DeleteModal">
                          Approve
                        </button>
                        {/*Change Status*/}
              ...
              <div className="flex justify-end items-center gap-x-2 py-3 px-4 mt-auto border-t dark:border-neutral-700">
                <button type="button" className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" data-hs-overlay="#Requests">
                  Close
                </button>
              </div>  
            </div>
