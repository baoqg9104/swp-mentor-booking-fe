      ...
      >
        <div className="relative flex flex-col h-full max-h-full">
          ...
          <div className="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
            ...
            >
              <ul className="flex flex-col space-y-1 text-[15px]">
                <li>
                  <button
                    onClick={() => setNavLink("dashboard")}
                    className={`${
                      navLink === "dashboard" && "bg-gray-100"
                    } w-full flex items-center gap-x-3.5 py-2 px-2.5 text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100`}
                  >
                    <svg
                      className="shrink-0 size-4"
                      xmlns="http://www.w3.org/2000/svg"
